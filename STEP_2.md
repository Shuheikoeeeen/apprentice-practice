...
CREATE TABLE文を実行し、STEP1で作成したテーブルをinternet_tvの中に作成します。以下のSQL文を実行し、テーブルを作成しましょう。
...
(1, 1, '2023-05-20', '20:00:00', 143023, NOW(), NOW()),
(1, 2, '2023-05-21', '20:00:00', 154123, NOW(), NOW()),
(2, 8, '2023-05-22', '19:30:00', 503412, NOW(), NOW()),
(3, 9, '2023-05-23', '19:30:00', 134234, NOW(), NOW()),
(3, 10, '2023-05-25', '21:00:00', 341343, NOW(), NOW()),
(3, 11, '2023-05-26', '21:00:00', 134144, NOW(), NOW()),
(3, 12, '2023-05-27', '21:00:00', 220134, NOW(), NOW()),
(4, 16, '2023-05-21', '18:00:00', 41234, NOW(), NOW()),
(5, 1, '2023-05-22', '22:30:00', 90123, NOW(), NOW());
