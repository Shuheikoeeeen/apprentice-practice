### Week5-6クエスト「インターネットTV」

#### STEP1
- 以下の手順でテーブル設計に取り組みました。

1. エンティティの抽出
2. エンティティの定義と正規化
3. ER図の作成

詳細についてはSTEP1の回答をご覧ください。

[STEP1回答](https://github.com/Shuheikoeeeen/apprentice-practice/blob/quest/STEP_1.md)

#### STEP2
- STEP1で作成したテーブルを構築し、サンプルデータを入れるまでの3つの手順をドキュメントとしてまとめました。
...
#### 好きな時間に好きな場所で話題の動画を無料で楽しめる「インターネットTVサービス」を新規に作成することになりました。データベース設計をした上で、データ取得する SQL を作成します。仕様はつぎのとおりです。
